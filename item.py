...
self.booking_bool
  ...
  def load_from_fields(self, fields):
    ...
    self.visitor_hist_starrating = fields[4]
    self.visitor_hist_adr_usd = fields[5]
    self.prop_country_id = fields[6]
    self.prop_id = fields[7]
    self.prop_starrating = fields[8]
    self.prop_review_score = fields[9]
    self.prop_brand_bool = fields[10]
    self.prop_location_score1 = fields[11]
    self.prop_location_score2 = fields[12]
